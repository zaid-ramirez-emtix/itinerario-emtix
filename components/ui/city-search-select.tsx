...
import { IconSearch, IconCheck, IconMapPin } from "@tabler/icons-react"
...
export function CitySearchSelect({
  ...
  return (
    <div ref={containerRef} className='relative w-full'>
      ...
      {isOpen && !isDisabled && (
        <div className='absolute top-full left-0 right-0 z-50 mt-2 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-lg shadow-lg max-h-60 overflow-y-auto'>
